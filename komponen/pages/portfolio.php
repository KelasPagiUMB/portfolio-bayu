            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <ul class="list-inline mb-4" id="portfolio-flters">
                        ...
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".first">Delphi</li>
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".second">Group</li>
                        <li class="btn btn-sm btn-outline-primary m-1" data-filter=".third">PHP Task</li>
                    </ul>
                </div>
            </div>
